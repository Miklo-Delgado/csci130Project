...
<body>
    ...
    <div class="Rules_section">
        ...
        <div class="Rules_rule_box">
            <p class="Rules_rule_text">
                ...
                We created the site cause we were told to... what you thought there was some meaningful backstory behind this site?
            </p>
        </div>
    </div>

    <div class="meet_devs_header">
        <div class="meet_devs_header_title">
            Meet the Developer Team
        </div>
    </div>
    
    <div class="devs_section">
        <div class="devs_name_section">
            <div class="james_pic">
                <img src="assets/img/jamesid.png" alt="james" style="height: 300px; width: 240px;">
            </div>
            <div class="dev_name_text">
                James Hernandez
            </div>
            <div class="dev_details">
                <p>
                    <svg><use xlink:href="#icon-chevron-right"></use></svg>
                    ;asdlf;asd;fajsd;fj;asd;fasldfj;alsd
                </p>
                
                <p>
                    <svg><use xlink:href="#icon-chevron-right"></use></svg>
                    ;lasdjfl;asdj;fajsdfasodfjlasdjlfja;s
                </p>
            </div>
        </div>
        ...
        <div class="devs_name_section">
            <div class="miklo_pic">
                <img src="assets/img/mikloid.jpg" alt="miklo" style="height: 300px; width: 300px;">
            </div>
            <div class="dev_name_text">
                Miklo Delgado
            </div>
    ...
    <div class="dbz_title">
        <div class="dbz_title_text">
             How the site came into being
        </div> 
    </div>

   <div class="dbz_reference">
       <div class="dbz_sections">
           <div class="dbz_sections_title">
               This
           </div>
           <div class="dbz_sections_img">
                <img src="assets/img/fusion1.png" alt="fusiion" style="height: 300px; width: 600px;">
           </div>
       </div>
       ...
       <div class="dbz_sections">
            ...
            <div class="dbz_sections_img">
                 <img src="assets/img/Gogeta1.png" alt="gogeta" style="height: 300px; width: 300px;">
            </div>
        </div>
   </div>
