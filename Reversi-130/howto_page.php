...
<body>
        ...
        <div class="header_nav">
            ...
            <div class="header_link">
                <a href="index.php">Home</a><!--add the wikipedia website for the how to play-->
    ...
    <div class="Rules_section">
        <div class="Rules_title">
            <div class="Rules_title_text">
                The Rules of Engagement:
            </div>
        </div>

        <div class="Rules_rule_box">
           
           <p class="Rules_rule_text">
                <svg><use xlink:href="#icon-chevron-right"></use></svg>
                Each of the disks' two sides corresponds to one player; they are referred to here as ''light'' and ''dark'' after the sides of ''Othello'' pieces, 
                but any counters with distinctive faces are suitable. The game may for example be played with a chessboard and Scrabble pieces, with one player 
                ''letters'' and the other ''backs''.
           </p>
           <p class="Rules_rule_text">
                <svg><use xlink:href="#icon-chevron-right"></use></svg>
                The historical version of Reversi starts with an empty board, and the first two moves made by each player are in the 
                four central squares of the board. The players place their disks alternately with their colors facing up and no captures 
                are made. A player may choose to not play both pieces on the same diagonal, different from the standard ''Othello'' opening. 
                 It is also possible to play variants of Reversi and ''Othello'' where the second player's 
                second move may or must flip one of the opposite-colored disks (as variants closest to the normal games).
           </p>
           <p class="Rules_rule_text">
                <svg><use xlink:href="#icon-chevron-right"></use></svg>
                For the specific game of ''Othello'' (differing from the historical Reversi), the rules state that the game begins with 
                four disks placed in a square in the middle of the grid, two facing white side up, two pieces with the dark side up, with 
                same-colored disks on a diagonal with each other. Convention has initial board position such that the disks with dark side 
                up are to the north-east and south-west (from both players' perspectives), though this is only marginally meaningful to play 
                (where opening memorization is an issue, some players may benefit from consistency on this). If the disks with dark side up 
                are to the north-west and south-east, the board may be rotated by 90° clockwise or counterclockwise. The dark player moves 
                first.
           </p>
           <p class="Rules_rule_text">
                <svg><use xlink:href="#icon-chevron-right"></use></svg>
                Dark must place a piece with the dark side up on the board, in such a position that there exists at least one straight 
                (horizontal, vertical, or diagonal) occupied line between the new piece and another dark piece, with one or more contiguous 
                light pieces between them. In the below situation, dark has the following options indicated by translucent pieces:
           </p>
           <p class="Rules_rule_text">
                <svg><use xlink:href="#icon-chevron-right"></use></svg>
                After placing the piece, dark turns over (flips, captures) all light pieces lying on a straight line between the new piece and 
                any anchoring dark pieces. All reversed pieces now show the dark side, and dark can use them in later moves—unless light has 
                reversed them back in the meantime. In other words, a valid move is one where at least one piece is reversed.
           </p>
           <p class="Rules_rule_text">
                <svg><use xlink:href="#icon-chevron-right"></use></svg>
                Players take alternate turns. If one player can not make a valid move, play passes back to the other player. When neither player 
                can move, the game ends. This occurs when the grid has filled up or when neither player can legally place a piece in any of the 
                remaining squares. This means the game may end before the grid is completely filled. This possibility may occur because one player 
                has no pieces remaining on the board in that player's color. In over-the-board play this is generally scored as if the board were 
                full (64–0).
           </p>
           <p class="Rules_rule_text">
                <svg><use xlink:href="#icon-chevron-right"></use></svg>
                The player with the most pieces on the board at the end of the game wins. An exception to this is that if a clock is employed then 
                if one player defaults on time that player's opponent wins regardless of the board configuration, with varying methods to determine 
                the official score where one is required.
           </p>
    ...
    <div class="Rules_section">
        ...
        <div class="Rules_rule_box">
            <p class="Rules_rule_text">
                <svg><use xlink:href="#icon-chevron-right"></use></svg>
                If you are still having trouble understanding how to play the game. Please feel free to check out the link below
                that goes to the official wikipedia page for Reversi.
                <a href="https://en.wikipedia.org/wiki/Reversi" target="_blank">Here</a>
            </p>
        </div>
    </div>
    ...
    <div class="Rules_section">
        <div class="Rules_title">
         ...
         <div class="Rules_rule_box">
            <p class="Rules_rule_text">
             <svg><use xlink:href="#icon-chevron-right"></use></svg>
                 That's okay we provide a pretty useful video that may answer your problems so please feel free to check it out.
                 
             </p>
             <iframe width="560" height="315" src="https://www.youtube.com/embed/Ol3Id7xYsY4" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
     </div>
